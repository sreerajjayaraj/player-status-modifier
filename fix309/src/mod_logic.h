...
bool TryRebindTrackedPlayerStatusComponentFromStats(uintptr_t entry, uintptr_t component, const char* reason);
void UpdateTrackedPlayerResourceOwner(uintptr_t owner_root, const char* reason);
