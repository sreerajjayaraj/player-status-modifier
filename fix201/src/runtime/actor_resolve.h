...
bool TryPromotePlayerCombatResourcesFromHealthEntry(uintptr_t health_entry, const char* reason);
bool TryResolvePlayerCombatResourcesFromHealthEntry(uintptr_t health_entry, ActorResolveSnapshot* resolved);
