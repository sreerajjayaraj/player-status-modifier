...
`version.dll` loads the ASI. The ASI then resolves `player-status-modifier.ini` as a sibling of the loaded ASI module, not from the process working directory.
